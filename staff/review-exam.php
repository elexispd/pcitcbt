                        ...
                        <?php 
                          ...
                          <td>
                            <div class="d-flex align-items-center">
                              <a href="exam-questions.php?c_id=<?php echo $_GET["c_id"] ?>&l_id=<?php echo $_GET["l_id"] ?>&co_no=<?php echo $value["course_no"] ?>&year=<?php echo $value['year'] ?>&cat=<?php echo $value['category']?>&st=<?php echo $value['status'] ?>" class="btn btn-info btn-sm btn-icon-text mr-3">
                                View
