        ...
        <ul class="navbar-nav mr-lg-2">
          ...
          <li class="nav-item">
            <div class="d-flex align-items-baseline">
              ...
              <p class="mb-0">Main Dahboard</p> <?php print_r($update_exam_status); ?>
            </div>
          </li>
        </ul>
      </div>
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <div class="d-flex align-items-center justify-content-between justify-content-md-center justify-content-xl-between flex-wrap mb-4">
                    <div>
                      <p class="mb-2 text-md-center text-lg-left">Active Corpers</p>
                      <h1 class="mb-0">NULL</h1>
                    </div>
                    <i class="typcn typcn-group icon-xl text-secondary"></i>
                  </div>
                  <canvas id="expense-chart" height="80"></canvas>
              ...
              <div class="card">
                <div class="table-responsive pt-3">
                  <table class="table table-striped project-orders-table">
                    <h5 class="card-title pl-4">Active student overview</h5>
                    <thead>
                      <tr>
                        <th class="ml-5">ID</th>
                        <th>Name</th>
