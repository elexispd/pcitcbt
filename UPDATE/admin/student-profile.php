                    ...
                    <?php foreach ($staff_student_profile as  $value) {?>
                      <div class="row">
                        ...
                        <div class="col-md-12 col-lg-8">
                          ...
                          <label class="font-weight-bold">Date OF Enlistment : </label> <span class="ml-3"><?php echo $value["date_of_enlistment"]?></span> <br> <br>
                          <label class="font-weight-bold">Date OF Promotion : </label> <span class="ml-3"><?php echo $value["date_last_promoted"]?></span> <br> <br>
                          <label class="font-weight-bold">Gender : </label> <span class="ml-3"><?php echo $value["gender"]?></span> <br> <br>
                          <label class="font-weight-bold">State of origin : </label> <span class="ml-3"><?php echo $value["state_of_origin"]?></span> <br> <br>
                          ...
                          <label class="font-weight-bold">Year of birth : </label> <span class="ml-3"><?php echo $value["year_of_birth"]?></span> <br> <br><label class="font-weight-bold">Date Documented : </label> <span class="ml-3"><?php echo $value["documented_at"]?></span> <br> <br>
                          <label class="font-weight-bold">End of course : </label> <span class="ml-3"><?php echo $value["course_ends"]?></span> <br> <br>
                          <label class="font-weight-bold">Course no.: </label> <span class="ml-3"><?php echo $value["course_no"]?></span> <br> <br>
                          <label class="font-weight-bold">SG : </label> <span class="ml-3"><?php echo $value["sg"]?></span> <br> <br>
                        </div>
                    </div>
                    <?php } ?>
                </div>
