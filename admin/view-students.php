                        ...
                        foreach ($get_students as $value) {?>
                          ...
                          <td>
                            <div class="d-flex align-items-center">
                              <a href="edit-student.php?id=<?php echo $value["id"]; ?>" class="btn btn-success btn-sm btn-icon-text mr-3">
                                Edit
                                <i class="typcn typcn-edit btn-icon-append"></i>                          
                              </a>
                              <a href="student-profile.php?id=<?php echo $value["id"]; ?>" class="btn btn-info btn-sm btn-icon-text mr-3">
                                View
                                <i class="typcn typcn-eye btn-icon-append"></i>                          
                              </a>
                              <form action="../php/includes/set.inc.php" method="post" id="del_form">
                                <input type="number" name="ap" value="<?php echo $value["id"]; ?>" hidden>
