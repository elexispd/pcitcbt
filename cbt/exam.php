              ...
              <div class="card">
                <div class="card-body">
                  <div class="d-lg-flex align-items-center">
                    <img class="img-fluid text-center"  src="<?php echo $get_student["photo"]?>" width="50">
                    <div id="flex">
                      <h1 class="card-title d-inline ml-3" style="font-size: 12px;">Hello,  <?php echo "{$get_student["first_name"]} {$get_student["last_name"]}" ?></h1>
                      <h5 class="text-secondary pl-3" style="font-size: 12px; ">Good Luck!</h5>
                    </div> 
                  </div>
                  <form method="post" action="../php/includes/set_exam.inc.php" class="w-50 mx-auto" id="form">
                    ...
                    <?php 
                        if (empty($get_e_questions)) {?>
                          <span class="d-block text-center">No Exam Yet</span>
                      <?php } 
                      elseif ($get_e_questions == 1) {?>
                        <h4>You have taken this exam. Choose another course</h4>
                          <div class="mx-auto mt-3 mb-5">
                            <a class="btn btn-info" href="home.php">Take Another Course</a>
                          </div>
                      <?php } else { ?>

                    <div class="counter">
                        <div class="input">
                          <input type="number" id="num" class="form-control" min="0" name="time" hidden>
                    ...
                    <h3 class="text-center text-primary pt-3" style="font-size: 1.5em;"><?php echo ucwords($_GET['c_id']) . "  Exam" ?></h3>
                    <span class="get" hidden><?php echo $_GET['c_id'] ?></span>                    
                                  ...
                                  <div>
                                    ...
                                    <div class="col-12">
                                      <div class="form-group">
                                        <h5 class="mb-2"><?php echo $value["question"] ?></h5>
                                        <input type="" name="q_id" value="<?php echo $value["question_id"]?>" hidden>
                                        <input type="" name="duration" value="<?php echo $duration?>" hidden>
                                        <input type="" name="c_id" value="<?php echo $_GET["c_id"] ?>" hidden>
                                        <input type="" name="id" value="<?php echo $_GET["id"] ?>" hidden>
                                        <input type="" name="s_id" value="<?php echo $_SESSION['student']; ?>" hidden>
                                        <input type="" name="c_no" value="<?php echo $get_student["course_no"] ?>" hidden>
