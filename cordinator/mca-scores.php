    ...
    <div class="container-fluid page-body-wrapper"  style="margin-top: 5em">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
            <div class="col-md-12">
              <h4 class="text-secondary">MCA Scores</h4>
              <div class="card">
                    ...
                    <tbody>
                      ...
                      $total = 0;
                        ...
                        <tr>
                          ...
                          <td><?php echo $value["excel"] ?></td>
                          <td><?php echo $value["powerpoint"] ?></td>
                          <td><?php echo $value["word"] ?></td>
                          <td><?php echo $value["internet"] ?></td>
                          <td><?php echo $value["ca"] ?></td>
                          <td><?php echo $value["typing"] ?></td>
                          <td><?php echo $value["english"] ?></td>
                          <td><?php echo $value["security"] ?></td>
                          <td><?php echo $value["gender"] ?></td>
                          <td><?php echo $value["communication"] ?></td>
                          <td><?php echo $value["corel"] ?></td>
